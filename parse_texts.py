...
fields = [
    'file_name', 'position', 'classcode', 'salary_start', 'salary_end',
    'start_date', 'end_date', 'req', 'notes', 'duties', 'selection',
    'experience_length', 'job_type', 'education_length', 'school_type', 'application_location'
]
